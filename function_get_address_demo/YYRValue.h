...
#pragma pack( push, 4)
struct RValue // VD: added default values for fields
{
	union {
		int32 v32;
		int64 v64;
	...
	unsigned int		flags = 0;							// use for flags (Hijack for Enumerable and Configurable bits in JavaScript)  (Note: probably will need a visibility as well, to support private variables that are promoted to object scope, but should not be seen (is that just not enumerated????) )
	unsigned int		kind = VALUE_REAL;							// kind of value
